...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #00A8FF, #CC9022, #ff8e7f);
...
<body>
    ...
    <div class="container">
        <form action="AddProjectMemberAction.php" method="post">
        <h1><i class="icon">📧</i> Add Members</h1>
        <?php
        ...
        ?>
        <p style="color:darkblue"><strong>Enter the email addresses of the members you want to Add your project</strong></p>
        <input  id="invitemail" type="email" class="email-input" name="email" placeholder="Email Address" required>
        <br>
        <button type="submit" class="invite-button">Add Member</button>
